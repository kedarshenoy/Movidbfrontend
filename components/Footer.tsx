...
export default function Footer() {
  ...
  const renderSection = ({ item }) => (
    <View style={styles.section}>
      ...
      {item.data.map((subItem) => (
        <TouchableOpacity key={subItem.key} onPress={() => Linking.openURL(subItem.link)}>
          <Text style={styles.item}>{subItem.key}</Text>
        </TouchableOpacity>
      ))}
    </View>
  );
  ...
  return (
    <View style={styles.footer}>
      <View style={styles.footerview}>
        <View style={styles.joinbtn}>
          <TouchableOpacity onPress={() => Linking.openURL('https://kedarshenoy.pages.dev/home')}>
